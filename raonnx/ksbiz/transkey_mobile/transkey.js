...
// demo
//var transkey_url = '/raonnx/ksbiz/transkey_mobile';
...
function mTranskeyObj(inputObj, width, div, keyType, keyboardType, dataType){
	...
	this.allocation = function(){
		...
		try {
			request.send(getUrlPost("allocation", this, "")+"&talkBack="+this.talkBack+tk_origin);
		} catch(e) {
...
//				new Image().src= url;
	...
	this.setBgImageForDivType1 = function(type){
		var url = getUrl("getKey", this, type, 0);
		if(type=="single"){
			for(var i=1; 5>i; i++){
				for(var j=0; 4>j; j++){
					try{
...
//			try{
//				this.div.childNodes[4].childNodes[0].childNodes[0].style.backgroundImage="url('"+url+"')";
//			}catch(e){
//				
//			}
			...
			for(var j=0; 4>j; j++){
				try{
					this.div.childNodes[5].childNodes[j].childNodes[0].style.backgroundImage="url('"+url+"')";
				}catch(e){
	...
	function getUrl(op, o, keyType, dummy){
		...
		+o.fieldType+"&inputName="+o.inputObj.name+"&transkeyUuid="+mtk.transkeyUuid+"&TK_requestToken="+TK_requestToken+"&dummy="+dummy+tk_origin;
	}
...
function mTranskey(){
	 ...
	 this.setPosition = function(){
		...
		this.setKeyIndex = function(inputObj) {
			...
			if(inputObj.getAttribute("data-tk-kbdtype") == "qwerty")
				keyIndex = Math.floor(Math.random() * qwertyMobileSize) + "";
			else
				keyIndex = Math.floor(Math.random() * numberMobileSize) + "";
			if((keyIndex/10)<1)
				keyIndex = "0"+keyIndex;
	...
	function qwertyMobileLayout(id, cssText){
		...
		'<span id="mtk_'+id+'_special" class="transkey_layout '+cssText.layout+'"></span>'+
			...
			'<div id="mtk_space" title="space" '+startEvent+'="mtk.done(event, this);"  class="transkey_key '+cssText.done+'"></div>'+
	...
	function qwertyMobileLayoutForDIV(id, cssText){
		...
		layout += '<div class="dv_'+cssText+'_disp_a">'+setTalkbackImg(id, '가상키보드 영역 입니다', false)+'</div>';
		layout += '<div class="dv_'+cssText+'_disp_b" '+startEvent+'="mtk.close();">'+setTalkbackImg(id, '가상키보드 닫기', false)+'</div></div>'+'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height dv_'+cssText+'_div_a">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 0);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 1);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 2);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 3);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 4);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 5);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 6);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 7);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 8);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 9);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-319px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height " '+startEvent+'="mtk.start(event, this, 10);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-354px -9px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2  dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 11);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 12);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 13);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 14);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 15);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 16);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 17);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 18);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 19);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 20);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-319px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 21);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-354px -60px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 22);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 23);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 24);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 25);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 26);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 27);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 28);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 29);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 30);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 31);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-319px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 32);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-354px -108px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height" id="mtk_cp" '+startEvent+'="mtk.cap(event, this);" ><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -158px;">'+setTalkbackImg(id, '쉬프트', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 33);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 34);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 35);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 36);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 37);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 38);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 39);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 40);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -161px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div_a dv_'+cssText+'_end dv_'+cssText+'_div2_Height" id="mtk_del" '+startEvent+'="mtk.del(event, this);"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-332px -158px;width:40px;">'+setTalkbackImg(id, '삭제', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  id="mtk_sp" '+startEvent+'="mtk.sp(event, this);"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_qTop" style="background-position:-15px -212px;">'+setTalkbackImg(id, '특수키', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  '+startEvent+'="mtk.clear(event, this);"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_qTop" style="background-position:-75px -212px;">'+setTalkbackImg(id, '삭제', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div2_Height" id="mtk_spacebar" '+startEvent+'="mtk.space(event, this);"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_qTop" style="background-position:-162px -212px;">'+setTalkbackImg(id, '스페이스 바', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_b dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.done(event, this);"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_qTop" style="width:75px;height:27px;background-position:-280px -212px;">'+setTalkbackImg(id, '입력완료', false)+'</div></div>'+
	'</div>';
	...
	var layout = '<div id="mtk_disp" class="dv_'+cssText+'_disp">';
		...
		layout += '<div class="dv_'+cssText+'_disp_a">'+setTalkbackImg(id, '가상키보드 영역 입니다', false)+'</div>';
		layout += '<div class="dv_'+cssText+'_disp_b" '+startEvent+'="mtk.close();">'+setTalkbackImg(id, '가상키보드 닫기', false)+'</div></div>'+'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 0);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -20px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 1);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-131px -20px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 2);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-228px -20px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 3);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-327px -20px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 4);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -81px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 5);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-131px -81px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 6);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-228px -81px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 7);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-327px -81px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 8);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -142px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 9);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-131px -142px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 10);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-228px -142px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 11);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-327px -142px;">'+setTalkbackImg(id, '', false)+'</div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  '+startEvent+'="mtk.del(event, this);"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-34px -203px;">'+setTalkbackImg(id, '삭제', false)+'</div></div>'+
		'<div class="dv_'+cssText+'_div2  dv_'+cssText+'_div_b dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.done(event, this);"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_nTop" style="background-position:-207px -203px;">'+setTalkbackImg(id, '확인', false)+'</div></div>'+
	'</div>';
		if(showLicense&&licenseType!="")
			layout += '<div class="dv_'+cssText+'_licenseType" style="position : absolute;margin: 5px; color : red;">' + licenseType + " (" + licExpiredDate + ")" + '</div>';
	...
	function setTalkbackImg(id, alt, style){
		...
		if(mtk_useTalkBack){
			if(style){
				img = '<a href="#none" style="width:100%;height:100%;position:absolute;top:0px;left:0px;"><img style="width:100%;height:100%;position:absolute;top:0px;left:0px;" src="'+transkey_url+'/images/0.png" alt="'+alt+'"></a>';
			}else{
				img = '<a href="#none" style="width:100%;height:100%;"><img style="width:100%;height:100%" src="'+transkey_url+'/images/0.png" alt="'+alt+'"></a>';
			}
		...
		for(var i=0;i<childNodes.length;i++){
			...
			if(child.tagName=="DIV"||child.tagName=="div"){
				for(var k=0;k<child.childNodes.length;k++){
					...
					if(key.id==""){
						try{
							var fChild = key.firstChild.firstChild.firstChild;
							key.firstChild.firstChild.removeChild(key.firstChild.firstChild.firstChild);
							key.firstChild.firstChild.appendChild(fChild);
						}catch(e){	
						}	
						...
						if(isNumber){
							...
							if("="==transkeyObj.talkBackNumberText[keyIndex]){
								key.firstChild.firstChild.firstChild.alt="빈칸";
							}else{
								try{
									key.firstChild.firstChild.firstChild.alt=textArray[keyIndex];
								}catch(e){	
								}								
							}
							keyIndex++;
			...
			for(var k=0;k<child.childNodes.length;k++){
				...
				if(key.tagName=="DIV"||key.tagName=="div"){
					if(key.id=="")
						...
						key.innerHTML = '<div style="width:100%;height:100%"><img style="width:100%;height:100%" src="'+transkey_url+'/images/0.png" alt="삭제"></div>';
					else if(key.id=="mtk_spacebar")
						key.innerHTML = '<div style="width:100%;height:100%"><img style="width:100%;height:100%" src="'+transkey_url+'/images/0.png" alt="스페이스 바"></div>';
...
mTranskey.prototype.onKeyboard = function(inputObj){
	 ...
	 if(this.now!=null&&this.now.useTranskey){
		...
		setTimeout(function(){
			if(mtk.now.talkBack){
				if(transkey_divType==1){
					mtk.now.div.firstChild.firstChild.firstChild.focus();
				}
			}
		},100);
...
mTranskey.prototype.space = function(e, ele){
	mtk.keyPress(e, ele, false);
